...
def main():
    ...
    thread = threading.Thread(target=process_frame, args=(k4a, model, mp_hands, frame_queue, width_det_pose, width_det_hand, running_flag))
    thread.start()
