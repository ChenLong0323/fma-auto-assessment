...
def process_frame(k4a, model, mp_hands, frame_queue, running_flag,fps_queue,
...
def main():
    ...
    thread = threading.Thread(target=process_frame, args=(k4a, model, mp_hands, frame_queue, running_flag,fps_queue,
                                                          dict_read, dict_pass, dict_hand, dict_result,
                                                          indices, trigger, count_sides, count
                                                          ))
    thread.start()
