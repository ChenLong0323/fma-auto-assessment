...
def main(name, save_path):
    ...
    while True:
        ...
        if np.any(capture.color):
            ...
            print('ir_frame.shape =', ir_frame.shape)

            # cv2.imwrite(os.path.join(save_path + '/rgb', f"{name}_rgb_{frame_count}.png"), rgb_frame, )
            #cv2.imwrite(os.path.join(save_path + '/depth', f"{name}_depth_{frame_count}.png"), depth_frame)
            #cv2.imwrite(os.path.join(save_path + '/ir', f"{name}_ir_{frame_count}.png"), ir_frame)
